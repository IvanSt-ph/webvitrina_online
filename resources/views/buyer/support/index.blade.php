...
<x-dynamic-component :component="$chatLayout ?? 'buyer-layout'" title="Служба поддержки">
    <div class="support-mobile-safe mx-auto w-full max-w-8xl min-w-0 px-3 py-4 pb-24 sm:px-6 sm:py-8 lg:pb-8">
        <div class="grid gap-4 xl:grid-cols-[minmax(0,1fr)_380px]">
            <section class="min-w-0 overflow-hidden rounded-2xl border border-indigo-100 bg-white shadow-sm">
                <div class="relative overflow-hidden border-b border-indigo-100 bg-gradient-to-br from-white via-indigo-50 to-slate-50 px-4 py-5 text-slate-950 sm:px-6 sm:py-7">
                    <div class="absolute inset-0 bg-[radial-gradient(circle_at_18%_18%,rgba(99,102,241,0.12),transparent_32%),radial-gradient(circle_at_88%_12%,rgba(148,163,184,0.18),transparent_30%)]"></div>
                    <div class="relative flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
                        <div class="max-w-2xl">
                            <p class="inline-flex items-center gap-2 rounded-full border border-indigo-100 bg-white px-3 py-1 text-xs font-semibold uppercase tracking-wide text-indigo-600 shadow-sm">
                                <i class="ri-customer-service-2-line text-base"></i>
                                WebVitrina support
                            </p>
                            <h1 class="mt-4 text-2xl font-bold tracking-tight sm:text-3xl">
                                Поможем с заказом, товаром, спором или безопасностью
                            </h1>
                        ...
                        @if($supportConversation)
                            <a href="{{ route('chats.show', $supportConversation) }}"
                               class="inline-flex h-11 shrink-0 items-center justify-center gap-2 rounded-xl bg-indigo-600 px-4 text-sm font-bold text-white shadow-lg shadow-indigo-600/20 transition hover:bg-indigo-700">
