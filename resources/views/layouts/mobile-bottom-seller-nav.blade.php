<div 
  ...
  <nav class="flex justify-around items-center h-16 text-xs font-medium">
    ...
    <a href="{{ route('cabinet') }}" 
       class="flex flex-col items-center gap-0.5 transition-all duration-200 {{ request()->routeIs('cabinet') ? 'text-indigo-600' : 'text-gray-500 hover:text-indigo-500' }}">
        <i class="ri-home-smile-2-line text-xl"></i>
        <span>Главная</span>
    </a>
    ...
    <button 
      ...
      class="flex flex-col items-center gap-0.5 transition-all duration-200 text-gray-500 hover:text-indigo-500 relative">
    ...
    <a href="{{ route('profile.edit') }}" 
       class="flex flex-col items-center gap-0.5 transition-all duration-200 {{ request()->routeIs('profile.*') ? 'text-indigo-600' : 'text-gray-500 hover:text-indigo-500' }}">
  ...
  <div 
    ...
    class="fixed bottom-20 left-0 right-0 bg-white rounded-t-2xl p-5 border-t border-gray-200 z-40">

    <div class="flex items-center justify-between mb-4">
      <h3 class="text-base font-semibold text-gray-800">Заказы</h3>
      <button @click="openMenu = false" class="text-gray-400 hover:text-gray-600">
