                            ...
                            <div class="space-y-1 rounded-2xl border border-slate-100 bg-slate-50/70 p-1">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <x-dropdown-link :href="route('logout')" 
                                        ...
                                        class="flex items-center gap-3 text-danger-600 hover:bg-danger-50 hover:text-danger-700">
                                        <span class="flex h-8 w-8 items-center justify-center rounded-xl bg-danger-50 text-danger-500">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
