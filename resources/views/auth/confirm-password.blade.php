        ...
        <section class="relative hidden overflow-hidden bg-slate-950 lg:block">
            ...
            <div class="relative z-10 flex h-full flex-col justify-between p-8 xl:p-10 text-white">
                ...
                <div class="max-w-md">
                    ...
                    <h1 class="text-4xl font-extrabold leading-tight tracking-tight">Подтвердите пароль.</h1>
                    <p class="mt-5 text-base leading-7 text-white/80">Это нужно перед важным действием в аккаунте.</p>
                </div>
                <div class="rounded-2xl border border-white/15 bg-white/10 p-4 text-sm text-white/75 backdrop-blur">
                    <i class="ri-shield-keyhole-line mr-2 text-indigo-100"></i>
                    Мы просим пароль повторно, чтобы защитить ваши данные.
                </div>
            </div>
        </section>
        ...
        <section class="flex min-h-[560px] flex-col bg-white/85 backdrop-blur-xl">
            ...
            <div class="flex flex-1 items-center px-5 py-7 sm:px-8 lg:px-10 xl:px-12">
                <div class="mx-auto w-full max-w-md">
                    <div class="mb-7">
                        <p class="text-sm font-semibold text-indigo-600">Подтверждение</p>
                        <h2 class="mt-2 text-3xl font-extrabold tracking-tight text-slate-950">Подтвердите пароль</h2>
                        <p class="mt-2 text-sm leading-6 text-slate-500">Это защищённая зона. Введите пароль перед продолжением.</p>
                    </div>
