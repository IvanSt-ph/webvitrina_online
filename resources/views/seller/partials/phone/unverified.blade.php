...
<div class="space-y-3">
    ...
    <div class="bg-gradient-to-br from-indigo-50/80 via-white to-purple-50/80 rounded-xl p-4 border border-indigo-100/50 shadow-sm">
        <h4 class="font-medium text-gray-900 mb-2.5 flex items-center gap-2">
        ...
        <form method="POST" action="{{ route('profile.shop.update') }}" id="shop-phone-save-form">
            @csrf
            @method('PATCH')
            ...
            <div class="space-y-2">
                ...
                {{-- На десктопе: кнопка справа, на мобилке: кнопка снизу --}}
                <div class="flex flex-col sm:flex-row gap-2">
                    ...
                    <button type="submit"
                            class="relative overflow-hidden group px-6 py-3 bg-indigo-500/90 hover:bg-indigo-600 
                                   ...
                                   flex items-center justify-center gap-2 backdrop-blur-sm border border-indigo-400/30
                                   sm:w-auto w-full">
