<x-app-layout title="Панель продавца" :hideHeader="true">
      ...
      <div class="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
        <div class="flex items-center gap-6">
          <a href="{{ route('home') }}" class="flex items-center gap-2">
            ...
            <span class="font-semibold text-gray-900 text-sm">WebVitrina Seller(Главная)</span>
          </a>

          <!-- Навигация -->
          <nav class="hidden sm:flex items-center gap-6 text-sm font-medium text-gray-600">
            <a href="#" class="hover:text-indigo-600 border-b-2 border-transparent hover:border-indigo-500 transition">Главная</a>
            <a href="{{ route('seller.products.index') }}" class="hover:text-indigo-600 border-b-2 border-transparent hover:border-indigo-500 transition">Товары</a>
            <a href="#" class="hover:text-indigo-600 border-b-2 border-transparent hover:border-indigo-500 transition">Заказы</a>
            <a href="#" class="hover:text-indigo-600 border-b-2 border-transparent hover:border-indigo-500 transition">Финансы</a>
            <a href="#" class="hover:text-indigo-600 border-b-2 border-transparent hover:border-indigo-500 transition">Аналитика</a>
          </nav>
        </div>
